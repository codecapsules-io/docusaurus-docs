...
# Scale Your WordPress Site Without Downtime
...
![Scale a Capsule](/gitbook-assets/products/wordpress-capsule/scale/wordpress-scale-edit.png)

Change the allocated resource for the Capsule with the sliders. Click **Save** when done.

![Configure Capsule Capacity](/gitbook-assets/products/wordpress-capsule/scale/wordpress-scale-custom.png)
