...
![Scale a Capsule](/gitbook-assets/products/database-capsule/scale/database-scale-edit.png)

Change the allocated resource for the Capsule with the sliders. Click "Save" when done.

![Configure Capsule Capacity](/gitbook-assets/products/database-capsule/scale/database-scale-custom.png)