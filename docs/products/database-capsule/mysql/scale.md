---
slug: '/products/database-capsule/mysql/scale'
...
![MySQL Capsule Scale tab Capsule Capacity plan selection](/gitbook-assets/products/database-capsule/scale/mysql-scale.png)
