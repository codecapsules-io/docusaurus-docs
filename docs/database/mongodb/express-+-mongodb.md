...
description: "Deploy an Express.js app with a MongoDB database on Code Capsules from GitHub. Connect Express to a managed Mongo Data Capsule, step by step."
---
